		...
		<%--删除购物车物品时给出提示--%>
			$(function (){
				$("a.deleteItem").click(function (){
					//通过this.parent().parent()取得dom对象，然后取得第一个td
				...
				//给输入框绑定失去焦点事件blur()函数？还是绑定内容发生改变事件change()?
	...
	<div id="main">
		...
		<c:if test="${not empty sessionScope.cart.items}">
			<div class="cart_info">
				...
				<span class="cart_span"><a class="clearCount" href="cartServlet?action=clearItem">清空购物车</a></span>
